    ...
    <div class="conntainer">
        ...
        <div class="container">
            <div class="input-text">
                ...
                <div class="input-div">
                     <asp:Button ID="Search" runat="server" Text="Filter" OnClick="Search_Click" CssClass="modern-btn" />
                </div>
            </div>     
        </div>
      <div class="col-sm-2 side_nav">
  <div class="row content">
      <h3><strong>Filter Appointments</strong></h3>
      <br />
      <ul class="nav nav-pills nav-stacked">       
         <li><asp:Button ID="btnUpcoming" runat="server" Text="Upcoming" OnClick="btnUpcoming_Click" CssClass="modern-btn"/></li>         
          <li><asp:Button ID="btnPast" runat="server" Text="Passed" OnClick="btnPast_Click" CssClass="modern-btn"/></li>
    ...
    <asp:GridView ID="Appointments" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="Appt_No" OnRowCommand="Appointments_RowCommand" AllowPaging="True" PageSize="5" CssClass="gridview" EmptyDataText="No appointments in this week.">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Cancel">
                <ItemTemplate>
                <asp:Button ID="btnDelete" runat="server" Text="Cancel" CommandName="DeleteAppointment" CommandArgument='<%# Eval("Appt_No") %>' CssClass="btn" />
            </ItemTemplate>
            </asp:TemplateField>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="modern-btn" data-dismiss="modal">Close</button>
   ...
   <div id="deleteModal" class="modal fade" tabindex="-1" role="dialog">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Cancelation Error</h4>
            </div>
            <div class="modal-body">
                <p>You cannot cancel an appointment within 24 hours of the scheduled time.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="modern-btn" data-dismiss="modal">OK</button>
            </div>
