                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button runat="server" OnClick="SendLinkButton_Click" Text="Email Link" CssClass="btn btn-default" />
                            <asp:Label ID="SuccessMessage" runat="server" Text="Label"></asp:Label>
                        </div>
                    </div>
                </div>
            </asp:PlaceHolder>
