                ...
                switch (result)
                {
                    case SignInStatus.Success:
                        ...
                        if (userType == "Patient")
                        {
                            ...
                            redirectUrl = "~/Private/manageappointments.aspx"; // Redirect to Patient Dashboard
                        }
                        else if (userType == "Doctor")
                        {
                            ...
                            redirectUrl = "/Private/Doctor/PatientInfo.aspx"; // Redirect to Doctor Dashboard
                        }
                        else if (userType == "Owner")
                        {
                            ...
                            redirectUrl = "~/Private/Owner/Reports.aspx"; // Redirect to Owner Dashboard
                        }
                        else
                        {
